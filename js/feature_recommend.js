...
const IMAGE_MAP = {
  ...
  "모리 칼리오페": "황_콜_모리칼리오페.png",
   "쿤 아센시오" : "황_데이터_쿤 아센시오.png",
   "크로노스 하유리": "황_크라노스_하유리.png",
   "포 비더 위고": "황_럭셔리_위고.png",
   "아우구스구스": "황_신수그림_아우구스구스.png",
   "토코야미 토와": "황_콜_토코야미토와.png",
   "아리 브라이트 샤론": "황_요정검_샤론.png",
   "로 포 비아 에블린": "황_비운의부리미_에블린.png"
};
...
const RECOMMEND_DATA = [
  {
   tier: "👑 가주급 (최상위)",
   characters: [
      { name: "루슬렉", content: "PvP 바리 세팅 (효적, 마관)\n압그 세팅 (효적, 마관)" },
      { name: "로 포 비아 트로이메라이", content: "바리(★) 4세트\n효적, 마관\n보조: 룬다 4세트" },
      { name: "포 비더 구스트앙", content: "바리(★) 4세트\n효적, 물관" },
      { name: "월하익송 우렉 마지노", content: "바리(★) / 도리스 4세트\n효적, 물관" }
    ]
  },
