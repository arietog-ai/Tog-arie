  ...
  content.innerHTML = `
    <div class="home-wrap">
      ...
      <div class="home-kakao-mobile">
        <a class="kakao-btn" href="https://open.kakao.com/o/g0u6l69h" target="_blank" rel="noopener noreferrer">💬 가입·접속 문의방</a>
        <a class="kakao-btn" href="https://open.kakao.com/o/sNNSi9mg" target="_blank" rel="noopener noreferrer">🛠️ 개발기능 요청방</a>
      </div>
    </div>
  `;
...
function renderGearHub() {
  ...
  content.querySelector('[data-route="draw"]').addEventListener('click', () => {
    resetDrawSession(); navigate('draw');
  });
...
export function navigate(route) {
  const hashMap = {
    shop:'#shop', gear:'#gear', draw:'#draw', starter:'#starter',
    'starter/estimator':'#starter/estimator', 'starter/reforge':'#starter/reforge',
    gacha:'#gacha', recommend:'#recommend', pack:'#pack', eel:'#eel', home:'',
  };
...
function renderFromHash() {
  ...
  content.innerHTML = '';
  if (mount) mount(); else renderHome();
  setActive(route);
